...
import { usePublicationsIt } from "../../shared/hooks/Publications/useListPublicationsIt";
...
export const ListPublicationsIT = () => {
  const { publications, loading, error, refresh } = usePublicationsIt();
  ...
  const { handleToggleLike, loading: likeLoading, error: likeError } =
    useToggleLike();
